        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="p-3.5 rounded-2xl bg-stone-50 border border-stone-200 text-center">
                <span className="font-heading font-black text-xl sm:text-2xl text-blue-600 block">
                  2:00 AM
                </span>
              ...
              <div className="p-3.5 rounded-2xl bg-stone-50 border border-stone-200 text-center">
                <span className="font-heading font-black text-xl sm:text-2xl text-red-600 block">
                  100%
                </span>
                <span className="text-[10px] text-stone-500 font-bold uppercase tracking-wider">
                  Pure Quality
          ...
          <div className="lg:col-span-6 space-y-5">
            ...
            <h2 className="font-heading font-black text-2xl sm:text-4xl lg:text-5xl text-stone-900 leading-tight">
              ...
              <span className="text-red-600">Late-Night Food & Ice Cream</span> Destination
            </h2>

            <p className="text-sm sm:text-base text-stone-600 leading-relaxed">
              Located in the commercial heart of Green City, Lahore, <strong>Frosty's</strong> serves fresh pure dairy ice cream scoops, freshly rolled waffle cones, Banana Splits, cold coffees, shakes, as well as juicy flame-grilled burgers, wraps, and loaded fries until 2:00 AM daily.
            </p>

            {/* Feature Highlights */}
            <div className="space-y-3 pt-1">
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-lg bg-blue-50 text-blue-700 flex items-center justify-center shrink-0 mt-0.5 border border-blue-200">
                  <i className="fa-solid fa-shield-halved text-sm"></i>
                </div>
                <div>
                  <h4 className="font-bold text-sm text-stone-900">100% Quality & Fresh Preparation</h4>
                  <p className="text-xs text-stone-600">
                    We use 100% pure dairy cream for desserts, and freshly marinated ingredients prepared to order.
                  </p>
                </div>
              </div>

              <div className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-lg bg-red-50 text-red-700 flex items-center justify-center shrink-0 mt-0.5 border border-red-200">
